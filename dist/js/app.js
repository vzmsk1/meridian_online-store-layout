    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".shopify__slider")) new core(".shopify__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".shopify-slider__arrow_prev",
                    nextEl: ".shopify-slider__arrow_next"
                },
                pagination: {
                    el: ".swiper-pagination",
                    type: "progressbar"
            ...
            if (document.querySelector(".reviews-mainpage__slider")) {
                new core(".reviews-mainpage__slider", {
                    ...
                    navigation: {
                        prevEl: ".control-reviews-slider__arrow_prev",
                        nextEl: ".control-reviews-slider__arrow_next"
                    },
                    pagination: {
                        el: ".swiper-pagination",
                        type: "fraction"
            ...
            if (document.querySelector(".reviews-product__slider")) new core(".reviews-product__slider", {
